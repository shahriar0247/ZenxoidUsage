...
import static com.shahriar.zenxoid.zenxoidusage.create_element.adding_items;
import static com.shahriar.zenxoid.zenxoidusage.create_element.delete_items;

public class GetherInfo {
    ...
    static List<UsageStats> getting_all_apps_usage(String time, UsageStatsManager mUsageStatsManager) {
    ...
    static List gettingservice(UsageStatsManager mUsageStatsManager, LayoutInflater mInflater, PackageManager mPm, FragmentActivity activity) {
